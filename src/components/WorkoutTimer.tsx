                ...
                <div className="flex flex-col items-center border-r border-white/10 pr-2">
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    <button
                      ...
                      className="min-h-[40px] px-3 bg-neutral-950 border border-white/10 rounded text-[11px] hover:bg-neutral-800 transition-colors cursor-pointer text-neutral-300"
                    >
                      -10
                    </button>
                    <button
