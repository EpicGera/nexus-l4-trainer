                  ...
                  <li key={i} className="text-[11px] font-mono text-neutral-300 flex items-start gap-2">
                    ...
                    {a.kind !== "pr-bump" && (
                      <button
                        type="button"
                        onClick={() => skip(a)}
                        className="shrink-0 text-[9px] font-mono uppercase tracking-wider text-[var(--color-ink-faint)] hover:text-[var(--color-ink)] hover:border-[var(--color-ink-muted)] px-1.5 py-0.5 rounded-sm transition-colors cursor-pointer"
