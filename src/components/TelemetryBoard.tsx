          ...
          <div className="space-y-3">
            {crew.length === 0 ? (
              ...
              <ul className="space-y-1.5">
                {crew.map((member) => (
                  <li
                    key={member.id}
                    className="flex items-center gap-2 bg-black/60 border border-white/10 rounded-sm px-3 py-2"
                  >
            ...
            <div className="flex flex-col gap-1.5 pt-1 border-t border-white/5">
              <input
                ...
                maxLength={24}
                className="bg-black/80 border border-white/15 rounded-sm px-3 py-2 text-[11px] font-mono text-white placeholder:text-neutral-600 focus:outline-none focus:border-emerald-500/50"
              />
              <div className="flex gap-1.5">
                <input
                  ...
                  maxLength={40}
                  className="flex-grow min-w-0 bg-black/80 border border-white/15 rounded-sm px-3 py-2 text-[11px] font-mono text-white placeholder:text-neutral-600 focus:outline-none focus:border-emerald-500/50"
                />
                <NexusButton
                  variant="good"
                  icon={<Plus size={12} />}
