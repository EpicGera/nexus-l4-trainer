...
export default function ChapterSwitcher() {
  ...
  return (
    <div className="mt-5 pt-4 border-t border-white/10 text-left space-y-3">
      ...
      <div className="flex items-center justify-between gap-2 border border-white/10 bg-white/[0.03] px-2.5 py-2 rounded-sm">
        ...
        {user && (
          <button
            ...
            className="shrink-0 flex items-center gap-1 text-[9px] font-mono font-black uppercase tracking-wider px-2 py-1 rounded-sm bg-white/10 text-neutral-200 hover:bg-white hover:text-black transition-all cursor-pointer disabled:opacity-60"
          >
            {cloudState === "saving" ? (
      ...
      <div className="space-y-2">
        {chapters.map((c) => {
          ...
          return (
            <div
              key={c.id}
              className={`border rounded-sm transition-all ${isActive ? "border-white/25 bg-white/[0.04]" : "border-white/10 bg-black/40 opacity-60 hover:opacity-100"}`}
            >
              <div className="flex items-center gap-2 p-2.5">
                ...
                {isActive ? (
                  ...
                  <button
                    ...
                    className="shrink-0 flex items-center gap-1 text-[9px] font-mono font-black uppercase tracking-wider px-2 py-1.5 rounded-sm bg-white/10 text-neutral-200 hover:bg-white hover:text-black transition-all cursor-pointer"
                  >
      ...
      {isAdmin && activeChapter && (
        <div className="mt-4 pt-4 border-t border-white/10 space-y-2">
          ...
          <select
            ...
            className="w-full bg-black/50 border border-white/15 text-neutral-200 text-[11px] font-mono px-2 py-2 rounded-sm focus:outline-none focus:border-white/40 cursor-pointer"
          >
            {FONT_OPTIONS.map((o) => (
          ...
          <div
            className="border border-white/10 bg-black/40 px-3 py-3 text-center text-white text-2xl truncate"
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 text-[10px] font-mono font-black uppercase tracking-wider border border-white/15 bg-white/5 text-neutral-200 hover:bg-white/10 cursor-pointer rounded-sm"
          >
