...
// (Sidequest AI retirado: las misiones ahora son deterministas en missionEngine.ts)
...
// (Coach Chat retirado: reemplazado por el validador determinista de misiones)
